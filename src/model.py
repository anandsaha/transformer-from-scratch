...
class MultiHeadAttentionBlock(nn.Module):
    ...
    @staticmethod
    def attention(q, k, v, mask, dropout=None) -> tuple[torch.Tensor, torch.Tensor]:
        d_k = q.shape[-1]
...
class Transformer(nn.Module):
    ...
    def __init__(self, encoder: Encoder, decoder: Decoder, src_embed: InputEmbeddings, tgt_embed: InputEmbeddings, src_pos: PositionalEmbeddings, tgt_pos: PositionalEmbeddings, projection: ProjectionLayer):
        super().__init__()
